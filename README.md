...
👉 **Please, due to a issue with memory use development branch while problem gets sorted out.** It uses a [modified version of the Sensirion Gadget BLE Arduino Lib]( git+https://github.com/melkati/arduino-ble-gadget.git#setSampleIntervalMs)
